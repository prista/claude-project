...
const btnBase = 'px-2 py-1 rounded text-sm font-medium transition-colors cursor-pointer';
...
export default function EditorToolbar({ editor }: EditorToolbarProps) {
  ...
  return (
    <div className='flex items-center gap-1 border-b border-zinc-700 px-2 py-1'>
      ...
      {btn('P', editor.isActive('paragraph'), () => editor.chain().focus().setParagraph().run())}
